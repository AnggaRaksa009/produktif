...
public class FormAdminStaffManagement extends TransisiForm {
    ...
    private void initComponents() {
        ...
        add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 440, 100, 40));
        ...
        add(btn_ubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, 100, 40));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 100, 40));
        ...
        add(no_hp_staff, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 200, 30));
        add(alamat_staff, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 200, 30));
        add(nama_staff, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 210, 200, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String sql = "insert into staff (kode_staff,nama_staff,alamat,no_hp,jk) values ('" + id_staff.getText() + "','" + nama_staff.getText() + "','" + alamat_staff.getText() + "','" + no_hp_staff.getText() + "','" + jComboBox1.getSelectedItem() + "')";
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "DELETE FROM staff WHERE kode_staff = " + id_staff.getText() + "";
            conn = (Connection) koneksi.configDB();
            pst = conn.prepareStatement(sql);
            pst.execute();
            //notif berhasil
        ...
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString(1),
                    rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(7)
                });
